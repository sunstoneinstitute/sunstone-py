...
class TestBasicOperations:
    ...
    @pytest.fixture
    def sample_df(self, project_path: Path):
...
class TestSelectionAndIndexing:
    ...
    def test_getitem_single_column(self, sample_df):
    ...
    def test_getitem_multiple_columns(self, sample_df):
    ...
    def test_setitem(self, sample_df):
...
class TestGroupByAndAggregation:
    ...
    def test_groupby_simple(self, sample_df):
    ...
    def test_groupby_first(self, sample_df):
...
class TestMergeAndJoin:
    ...
    @pytest.fixture
    def df1(self, project_path: Path):
    ...
    @pytest.fixture
    def df2(self, project_path: Path):
    ...
    def test_merge_basic(self, df1, df2):
...
class TestConcat:
    ...
    def test_concat_basic(self, df1, df2):
    ...
    def test_concat_ignore_index(self, df1, df2):
